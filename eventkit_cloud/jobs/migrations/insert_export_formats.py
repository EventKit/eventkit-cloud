...
class Migration(migrations.Migration):
    def insert_export_formats(apps, schema_editor):  # NOQA
        ...
        ExportFormat.objects.create(
            name="Geopackage", description="GeoPackage", slug="gpkg"
        )
        ExportFormat.objects.create(
        ...
        ExportFormat.objects.create(
            name="KML Format", description="Google Earth KMZ", slug="kml"
        )
        ExportFormat.objects.create(
            name="SQLITE Format", description="SQlite SQL", slug="sqlite"
        )
        ExportFormat.objects.create(
            name="GeoTIFF Format", description="GeoTIFF Raster", slug="gtiff"
        )
