...
export class NotificationsPage extends React.Component<Props, State> {
    ...
    constructor(props: Props, context) {
        ...
        this.handleLoadMoreDisabled = this.handleLoadMoreDisabled.bind(this);
        this.handleLoadMoreDisabled = this.handleLoadMoreDisabled.bind(this);
    ...
    componentDidUpdate(prevProps: Props) {
        ...
        console.log(this.props.notificationsData.nextPage);
    }
    ...
    async handleLoadMoreDisabled() {
        // this.props.getNotifications({ pageSize: this.state.pageSize });
        const nextPage = await this.props.notificationsData.nextPage;
        if (!nextPage) {
            return true;
        }
                                    ...
                                    : (
                                        <div className="qa-NotificationsPage-Content-Notifications">
                                            ...
                                            <LoadButtons
                                                ...
                                                loadMoreDisabled={this.handleLoadMoreDisabled}
                                            />
                                        </div>
                                    )
                                }
