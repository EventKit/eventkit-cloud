...
from ..arcgis_feature_service import ArcGISFeatureServiceToSQLITE

logger = logging.getLogger(__name__)


class TestArcFeatureServiceToSQLITE(SimpleTestCase):
    def setUp(self, ):
    ...
    def test_create_convert(self, popen, pipe, exists):
        ...
        cmd = Template("ogr2ogr -skipfailures -t_srs EPSG:3857 -spat_srs EPSG:4326 -spat $minX $minY $maxX $maxY -f SQLite $sqlite '$url'")
        ...
        w2g = ArcGISFeatureServiceToSQLITE(sqlite=sqlite,
                          bbox=bbox,
