...
from ..mapproxyutils import (MapproxyGeopackage,
...
class TestGeopackage(TransactionTestCase):
    ...
    @patch('eventkit_cloud.utils.mapproxyutils.auth_requests.patch_https')
    @patch('eventkit_cloud.utils.mapproxyutils.set_gpkg_contents_bounds')
    @patch('eventkit_cloud.utils.mapproxyutils.check_zoom_levels')
    @patch('eventkit_cloud.utils.mapproxyutils.check_service')
    @patch('eventkit_cloud.utils.geopackage.remove_empty_zoom_levels')
    @patch('eventkit_cloud.utils.mapproxyutils.connections')
    @patch('eventkit_cloud.utils.mapproxyutils.SeedingConfiguration')
    @patch('eventkit_cloud.utils.mapproxyutils.seeder')
    @patch('eventkit_cloud.utils.mapproxyutils.load_config')
    @patch('eventkit_cloud.utils.mapproxyutils.get_cache_template')
    @patch('eventkit_cloud.utils.mapproxyutils.get_seed_template')
...
class TestHelpers(TransactionTestCase):
    ...
    @patch('eventkit_cloud.utils.mapproxyutils.auth_requests.get')
    ...
    @patch('eventkit_cloud.utils.mapproxyutils.sqlite3')
    @patch('eventkit_cloud.utils.mapproxyutils.get_table_tile_matrix_information')
    @patch('eventkit_cloud.utils.mapproxyutils.get_zoom_levels_table')
    @patch('eventkit_cloud.utils.mapproxyutils.get_tile_table_names')
