...
class TestReverseGeoCode(TestCase):
    ...
    @override_settings(
        REVERSE_GEOCODING_API_URL="http://pelias.url/",
    ...
    @override_settings(
        REVERSE_GEOCODING_API_URL="http://pelias.url/", REVERSE_GEOCODING_API_TYPE="pelias", GEOCODING_UPDATE_URL=""
    )
    ...
    @override_settings(REVERSE_GEOCODING_API_URL="", GEOCODING_API_TYPE="")
    ...
    @override_settings(REVERSE_GEOCODING_API_URL="http://nominatim.url/", REVERSE_GEOCODING_API_TYPE="nominatim")
