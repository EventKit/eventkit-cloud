...
REVERSE_GEOCODING_API_URL = os.getenv('REVERSE_GEOCODING_API_URL', 'https://pelias.dev.dev.east.paas.geointservices.io/v1/reverse')
...
CONVERT_API_URL = os.getenv('CONVERT_API_URL', 'http://172.17.0.1:3100/v1/convert')
