...
/var/lib/eventkit/.virtualenvs/eventkit/bin/python /var/lib/eventkit/manage.py celery worker --concurrency=$CONCURRENCY --loglevel=$LOGLEVEL -n $HOSTNAME -Q "${HOSTNAME}-cancel",celery,$HOSTNAME
