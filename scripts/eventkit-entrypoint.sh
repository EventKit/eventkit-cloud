...
cd /var/lib/eventkit && /var/lib/eventkit/.virtualenvs/eventkit/bin/gunicorn eventkit_cloud.wsgi:application --bind cloud.eventkit.dev:80 --worker-class eventlet --workers 1 --threads 2 --name eventkit --user eventkit --no-sendfile
